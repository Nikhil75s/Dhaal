// Catalyst serverless entry point for ai_predictions_api.
...
const MODULE_NAME = 'ai_predictions';
const controller = new AiPredictionsController();

/**
 * Catalyst runtime adapter for the ai_predictions_api function.
 *
...
module.exports = async function (context, basicIO) {
  try {
    ...
    console.error('AiPredictions runtime error:', error);
